...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000054e4d486000000002434f75a(
...
class phpbbtemplatetwiglexer_0000000054e4d486000000002434f75a extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5af95a0994d6f126328358 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5af95a0994d82665761939 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5af95a0994d3a729996019 = array(
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, 'set_environment', array('env' => $env), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;

        return $this->valueHolder5af95a0994d6f126328358->set_environment($env);
    }
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;

        return $this->valueHolder5af95a0994d6f126328358->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;

        return $this->valueHolder5af95a0994d6f126328358->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5af95a0994d82665761939 = $initializer;
    }
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, '__get', array('name' => $name), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;

        if (isset(self::$publicProperties5af95a0994d3a729996019[$name])) {
            return $this->valueHolder5af95a0994d6f126328358->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5af95a0994d6f126328358;
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, '__isset', array('name' => $name), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, '__unset', array('name' => $name), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;
    ...
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, '__clone', array(), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;

        $this->valueHolder5af95a0994d6f126328358 = clone $this->valueHolder5af95a0994d6f126328358;
    }

    public function __sleep()
    {
        $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, '__sleep', array(), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;

        return array('valueHolder5af95a0994d6f126328358');
    }
    ...
    {
        return $this->initializer5af95a0994d82665761939;
    }
    ...
    {
        return $this->initializer5af95a0994d82665761939 && ($this->initializer5af95a0994d82665761939->__invoke($valueHolder5af95a0994d6f126328358, $this, 'initializeProxy', array(), $this->initializer5af95a0994d82665761939) || 1) && $this->valueHolder5af95a0994d6f126328358 = $valueHolder5af95a0994d6f126328358;
    }
    ...
    {
        return null !== $this->valueHolder5af95a0994d6f126328358;
    }
    ...
    {
        return $this->valueHolder5af95a0994d6f126328358;
    }
